...
def registration(request):
    if request.method == 'POST':
        ...
        if form_data['institute_password'] == form_data['confirm_password']:
            ...
            institute_result = institute_instance.create_institute_in_subscription(form_data, "/create_institute/")
...
def login(request):
    if request.method == 'POST':
        ...
        if auth_response.status_code == 200:
            ...
            institite_url = f'{API_URL}/Institute/Institute/?institute_id={institite_id}'
...
def edit_staff(request,staff_slug):
    ...
    if staff_slug:
        ...
        staff_data = staff.get_staff_data(f"/Staff/get_staffs_by_field/slug/{staff_slug}/")
        staff_data["data"]["address"] = staff_data["data"]["address"].split(",")
        staff_payroll_data = staff.get_staff_payroll_data(staff_data["data"]["staff_id"])
